  ...
  "@graph": [
    {
      ...
      description:
        "TripAdvert is Accra's leading digital out-of-home (DOOH) advertising platform, delivering targeted ads to passengers through headrest-mounted tablet displays in taxis and ride-share vehicles across Ghana.",
      areaServed: {
        "@type": "City",
        name: "Accra",
        containedInPlace: {
...
export default function Home() {
  return (
    <main className="min-h-screen bg-slate-50 font-sans text-slate-900 selection:bg-teal-500/30">
      ...
      {/* Social Proof */}
      <section aria-label="Trusted partners" className="bg-white py-16 px-6 z-20 relative border-b border-slate-100">
        <div className="mx-auto max-w-7xl text-center">
          ...
          <div className="mt-10 flex flex-wrap justify-center items-center gap-12 sm:gap-20 opacity-50 grayscale transition-all hover:grayscale-0 hover:opacity-100 duration-700">
            <span className="text-3xl font-black font-serif tracking-tighter">Margins Group</span>
            <span className="text-2xl font-bold font-sans tracking-tight">Fontissue</span>
            <span className="text-4xl font-black font-sans tracking-tighter text-yellow-500 italic">MTN</span>
            <span className="text-3xl font-bold font-mono tracking-widest text-slate-800">Arena233</span>
            <span className="text-2xl font-medium tracking-widest uppercase border-b-2 border-current pb-1">Debbies</span>
          </div>
        </div>
      </section>

      {/* The Tech Section */}
      <section id="features" aria-label="Platform features" className="py-24 px-6 bg-slate-50">
      ...
      <section id="how-it-works" aria-label="How it works" className="py-24 px-6 bg-slate-900 text-white border-y border-slate-800">
        <div className="mx-auto max-w-7xl">
      ...
      <section className="py-24 px-6 bg-teal-500 text-slate-900 border-b-8 border-teal-600">
        <div className="mx-auto max-w-4xl text-center">
          ...
          <p className="mt-6 text-xl text-teal-950 font-medium">
            Join the TripAdvert network in Accra. Install our premium HD headrest tablets in your cabs and start earning passive income on every ride.
          </p>
          <div className="mt-10">
        ...
        <div className="mx-auto max-w-7xl grid md:grid-cols-4 gap-12 md:gap-8">
          <div className="md:col-span-2 border-r border-slate-100 pr-8">
            ...
            <p className="text-slate-500 mb-8 max-w-sm text-lg leading-relaxed">
              Accra&apos;s leading in-vehicle digital advertising platform. Reach passengers through headrest-mounted tablet displays in taxis across Ghana.
            </p>
            <address className="not-italic text-sm text-slate-400 mb-6">
              Accra, Ghana
            </address>
